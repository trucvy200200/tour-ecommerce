        ...
        <div className="fixed">
            <div className="bg-[#ffb700] rounded-[8px] p-[4px]">
                <div className="relative">
                    <input className="font-normal border-b-[2px] outline-none text-[#333] rounded-t-[8px] 
                ...
                <div className="relative">
                    <input className="font-normal border-none outline-none text-[#333] rounded-b-[8px] 
                                text-[18px] px-[50px] py-[14px] px-[15px] w-full"
                        placeholder="To..."
                    />
                ...
                <button className="w-full py-3 text-[white] bg-[#006ce4] rounded-[8px] mt-2 font-bold hover:bg-[#004b9a]">
                    Search
                </button>
            </div>
                    ...
                    {locationOption.map((item, index) => (
                        <div key={index} className="flex items-center gap-3 cursor-pointer">
                            <input
                                ...
                                onChange={(e) => handleSelectLocation(e.target)}
                            />
                    ...
                    {priceOption.map((item, index) => (
                        <div key={index} className="flex items-center gap-3 cursor-pointer">
                            ...
                            {item.fromValue && item.toValue ?
                                <div className="text-[14px]">VND {item.fromValue} - VND {item.toValue}</div> :
