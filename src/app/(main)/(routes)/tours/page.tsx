...
const Tour = () => {
  ...
  return (
    <div className="container mt-[160px] grid grid-cols-[35%_65%] gap-[20px] max-md:grid-cols-1 max-md:mt-[90px]">
      <div>
        <Fitler />
      </div>
      <div>
        <div className="mb-[20px] flex gap-[30px] bg-[#f5f5f5] h-[fit-content] rounded-[999px] justify-center py-1 border-[1px] border-[#f5f5f5]">
          <div className="cursor-pointer px-[4rem] max-md:px-3 rounded-[999px] bg-[#fff] py-1 border-[1px] border-[#000] whitespace-nowrap">Most popular</div>
          <div className="cursor-pointer px-[4rem] max-md:px-3 whitespace-nowrap">Lowest price</div>
        </div>
